...
class LDOVoltage:
    LDO_3V3 = const(0x4)  # LDV 3.3 volts; _CTRL1[5:3] = 4
...
class NAU7802:
    def __init__(self, i2c_bus, address=0x2A, active_channels=1):
        ...
        self.ldo_voltage     = '3V3'  # 3.0-volt internal analog power (AVDD)
    ...
    def ldo_voltage(self, voltage='EXTERNAL'):
        """Select the LDO Voltage. Valid voltages are '2V4', '2V7', '3V0', '3V3'."""
